export default function Posts() {
  return (
    <>
      <h2 className="text-center font-bold text-3xl tracking-wider small-caps text-white">
        All Posts
      </h2>
      <section className="grid min-h-screen p-8 place-items-center">
        <div className="container grid grid-cols-1 gap-8 my-auto lg:grid-cols-2">
          {/* post 1 */}
          <div className="relative flex-col bg-clip-border rounded-xl bg-transparent text-white shadow-none grid gap-2 item sm:grid-cols-2">
            <div className="relative bg-clip-border rounded-xl overflow-hidden text-white shadow-lg m-0">
              <img
            ...
            <div className="p-6 px-2 sm:pr-6 sm:pl-4">
              ...
              <a
                href="#"
                className="block antialiased tracking-normal font-sans text-xl font-semibold leading-snug hover:text-gray-900 mb-2 normal-case transition-colors text-white"
              >
                Revolutionizing Our Production Process
              </a>
              <p className="block antialiased font-sans text-base leading-relaxed text-inherit mb-8 font-normal text-white hover:text-gray-700 ">
          ...
          <div className="relative flex-col bg-clip-border rounded-xl bg-transparent text-white shadow-none grid gap-2 item sm:grid-cols-2">
            ...
            <div className="p-6 px-2 sm:pr-6 sm:pl-4">
              ...
              <a
                href="#"
                className="block antialiased tracking-normal font-sans text-xl font-semibold leading-snug text-white mb-2 normal-case transition-colors hover:text-gray-700"
              >
                Expanding Our Service Network
              </a>
              <p className="block antialiased font-sans text-base leading-relaxed text-inherit mb-8 font-normal hover:text-gray-500 text-white">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="block antialiased font-sans text-sm leading-normal text-white hover:text-gray-700 font-normal">
                    2022-09-02
                  </p>
                </div>
              </div>
          ...
          <div className="relative flex-col bg-clip-border rounded-xl bg-transparent text-white shadow-none grid gap-2 item sm:grid-cols-2">
            <div className="relative bg-clip-border rounded-xl overflow-hidden bg-white text-white shadow-lg m-0">
              <img
            ...
            <div className="p-6 px-2 sm:pr-6 sm:pl-4">
              ...
              <p className="block antialiased font-sans text-base leading-relaxed text-inherit mb-8 font-normal text-white hover:text-gray-500">
              ...
              <div className="flex items-center gap-4">
                ...
                />
                <div>
                  <p className="block antialiased font-sans text-base font-light leading-relaxed text-white mb-0.5 ">
                    Alex Johnson
                  </p>
                  <p className="block antialiased font-sans text-sm leading-normal text-white hover:text-gray-700 font-normal">
                    2022-09-20
